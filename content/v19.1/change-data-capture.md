...
<span class="version-tag">New in v19.1:</span> {{ partial "{{ page.version.version }}/cdc/create-core-changefeed.md" . }}

### Create a core changefeed using Avro

<span class="version-tag">New in v19.1:</span> {{ partial "{{ page.version.version }}/cdc/create-core-changefeed-avro.md" . }}
