...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jdbc/JdbcApplication.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ xml
{{ partial "{{ page.version.version }}/app/spring-data-jdbc/changelog-master.xml" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ sql
{{ partial "{{ page.version.version }}/app/spring-data-jdbc/create.sql" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jdbc/Account.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jdbc/AccountModel.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jdbc/AccountRepository.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jdbc/AccountController.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jdbc/TransactionHintsAspect.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jdbc/RetryableTransactionAspect.java" . }}
~~~
