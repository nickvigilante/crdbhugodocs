...
{% include copy-clipboard.html %}
~~~ java
{% include {{< page-version >}}/app/spring-data-jpa/JpaApplication.java %}
~~~
...
{% include copy-clipboard.html %}
~~~ xml
{% include {{< page-version >}}/app/spring-data-jpa/changelog-master.xml %}
~~~
...
{% include copy-clipboard.html %}
~~~ sql
{% include {{< page-version >}}/app/spring-data-jpa/create.sql %}
~~~
...
{% include copy-clipboard.html %}
~~~ java
{% include {{< page-version >}}/app/spring-data-jpa/Account.java %}
~~~
...
{% include copy-clipboard.html %}
~~~ java
{% include {{< page-version >}}/app/spring-data-jpa/AccountModel.java %}
~~~
...
{% include copy-clipboard.html %}
~~~ java
{% include {{< page-version >}}/app/spring-data-jpa/AccountRepository.java %}
~~~
...
{% include copy-clipboard.html %}
~~~ java
{% include {{< page-version >}}/app/spring-data-jpa/AccountController.java %}
~~~
...
{% include copy-clipboard.html %}
~~~ java
{% include {{< page-version >}}/app/spring-data-jpa/RetryableTransactionAspect.java %}
~~~
