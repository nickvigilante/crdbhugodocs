...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jpa/JpaApplication.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ xml
{{ partial "{{ page.version.version }}/app/spring-data-jpa/changelog-master.xml" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ sql
{{ partial "{{ page.version.version }}/app/spring-data-jpa/create.sql" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jpa/Account.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jpa/AccountModel.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jpa/AccountRepository.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jpa/AccountController.java" . }}
~~~
...
{{ partial "copy-clipboard.html" . }}
~~~ java
{{ partial "{{ page.version.version }}/app/spring-data-jpa/RetryableTransactionAspect.java" . }}
~~~
