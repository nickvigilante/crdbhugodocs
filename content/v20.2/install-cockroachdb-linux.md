...
<p>See <a href="../releases/{{< page-version >}}.html" class="mac-releasenotes-download" id="mac-releasenotes-download-{{< page-version >}}" data-eventcategory="mac-releasenotes-download">Release Notes</a> for what's new in the latest release, {{ page.release_info.version }}. To upgrade to this release from an older version, see <a href="upgrade-cockroach-version.html">Cluster Upgrade</a>.</p>
...
<div id="use-docker-linux" class="install-option">
  ...
  <ol>
    ...
    <li>
      <p>Pull the image for the {{page.release_info.version}} release of CockroachDB from <a href="https://hub.docker.com/r/{{page.release_info.docker_image}}/" class="linux-docker-step3" id="linux-docker-step3-{{< page-version >}}" data-eventcategory="linux-docker-step3">Docker Hub</a>:</p>
...
<div id="build-from-source-linux" class="install-option">
  ...
  <ol>
    ...
    <li>
      <p>Download the <a href="https://binaries.cockroachdb.com/cockroach-{{ page.release_info.version }}.src.tgz" class="linux-source-download" id="linux-source-download-{{< page-version >}}" data-eventcategory="linux-source-download">CockroachDB {{ page.release_info.version }} source archive</a>, and extract the sources:</p>
