...
<div id="download-the-binary-windows" class="install-option">
  ...
  <ol>
    <li>
      <p>Download and extract the <a href="https://binaries.cockroachdb.com/cockroach-{{ page.release_info.version }}.windows-6.2-amd64.zip" class="windows-binary-download" id="windows-binary-download-{{< page-version >}}" data-eventcategory="windows-binary-download">CockroachDB {{ page.release_info.version }} archive for Windows</a>.</p>
    </li>
    <li>
...
<div id="use-docker-windows" class="install-option">
  ...
  <ol>
    ...
    <li>
      <p>Pull the image for the {{page.release_info.version}} release of CockroachDB from <a href="https://hub.docker.com/r/{{page.release_info.docker_image}}/" class="win-docker-step3" id="win-docker-step3-{{< page-version >}}" data-eventcategory="win-docker-step3">Docker Hub</a>:</p>
