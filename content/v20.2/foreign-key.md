...
<div>{{ partial "{{ page.version.version }}/sql/diagrams/foreign_key_column_level.html" . }}</div>
...
<div>{{ partial "{{ page.version.version }}/sql/diagrams/foreign_key_table_level.html" . }}</div>
