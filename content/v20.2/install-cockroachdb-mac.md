...
<div id="download-the-binary" class="install-option">
  ...
  <ol>
    ...
    <li>
      ...
      {{ partial "copy-clipboard.html" . }}<div class="highlight"><pre class="highlight"><code><span class="nv language-shell"></span>cp -i cockroach-{{ page.release_info.version }}.darwin-10.9-amd64/cockroach /usr/local/bin/</code></pre></div>
...
<div id="build-from-source" class="install-option">
  ...
  <ol>
    ...
    <li>
      <p>Keep up-to-date with CockroachDB releases and best practices:</p>
{{ partial "marketo-install.html uid="4"" . }}
    </li>
  </ol>
</div>
