...
-----------|-----------|------|---------
 ...
 Interleaved tables | ✓ | CockroachDB Extension | [Interleaved Tables documentation](interleave-in-parent.html)<br>{{ partial "{{ page.version.version }}/misc/interleave-deprecation-note.md" . }}
