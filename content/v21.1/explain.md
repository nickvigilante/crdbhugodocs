...
<div>{{ partial "{{ page.version.version }}/sql/generated/diagrams/explain.html" . }}</div>
...
--------------------+------------
 ...
 `DISTSQL`          | Generate a URL to a [distributed SQL physical statement plan tree](explain-analyze.html#distsql-plan-viewer).<br><br>{{ partial "{{ page.version.version }}/sql/physical-plan-url.md" . }}
