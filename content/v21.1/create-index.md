...
<div>{{ partial "{{ page.version.version }}/sql/generated/diagrams/create_index.html" . }}</div>

**GIN index:**

<div>{{ partial "{{ page.version.version }}/sql/generated/diagrams/create_inverted_index.html" . }}</div>
