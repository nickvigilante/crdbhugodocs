...
<div id="use-docker" class="install-option">
  ...
  <ol>
    ...
    <li>
      <p>Pull the image for the {{page.release_info.version}} release of CockroachDB from <a href="https://hub.docker.com/r/{{page.release_info.docker_image}}/" class="mac-docker-step3" id="mac-docker-step3-{{< page-version >}}" data-eventcategory="mac-docker-step3">Docker Hub</a>:</p>
...
<div id="build-from-source" class="install-option">
  ...
  <ol>
    ...
    <li>
      <p>Download the <a href="https://binaries.cockroachdb.com/cockroach-{{ page.release_info.version }}.src.tgz" class="mac-source-download" id="mac-source-download-{{< page-version >}}" data-eventcategory="mac-source-download">CockroachDB {{ page.release_info.version }} source archive</a>, and extract the sources:</p>
