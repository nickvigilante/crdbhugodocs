...
{% include {{< page-version >}}/sql/regional-table-description.md %}

#### Regional by row tables

{% include {{< page-version >}}/sql/regional-by-row-table-description.md %}
...
{% include {{< page-version >}}/topology-patterns/multiregion-db-setup.md %}
