...
1. Download [`BasicExample.java`](https://raw.githubusercontent.com/cockroachdb/docs/master/_includes/{{< page-version >}}/app/BasicExample.java), or create the file yourself and copy the code below.
...
The contents of [`BasicExample.java`](https://raw.githubusercontent.com/cockroachdb/docs/master/_includes/{{< page-version >}}/app/BasicExample.java):
...
The contents of [`BasicExample.java`](https://raw.githubusercontent.com/cockroachdb/docs/master/_includes/{{< page-version >}}/app/insecure/BasicExample.java):
